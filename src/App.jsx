...
export default function OtsukaresamaJinjaApp() {
  ...
  const fortunes = [
   ...
   { rank: "大吉", message: "無理に強く見せなくても、あなたは十分すてきです。", item: "お気に入りの香り" },

   { rank: "吉", message: "今日は早めにお風呂に入りましょう。心も少しゆるみます。", item: "入浴剤" },
   { rank: "吉", message: "十分頑張っています。今日は自分を褒める日にしましょう。", item: "温かい紅茶" },
   { rank: "吉", message: "誰かの機嫌を取りすぎなくて大丈夫です。", item: "イヤホン" },
   { rank: "吉", message: "今日は返信を急がなくても大丈夫。自分の時間を守りましょう。", item: "お気に入りのマグカップ" },
   { rank: "吉", message: "心が疲れたら、少しだけ空を見上げてください。", item: "青空" },

   { rank: "中吉", message: "そのモヤモヤは明日のあなたに任せましょう。", item: "温かいカフェラテ" },
   { rank: "中吉", message: "今日は70点で十分です。完璧じゃなくて大丈夫。", item: "やわらかいブランケット" },
   { rank: "中吉", message: "比べなくて大丈夫。あなたにはあなたのペースがあります。", item: "手帳" },
   { rank: "中吉", message: "一度深呼吸。今すぐ全部決めなくて大丈夫です。", item: "ミントタブレット" },
   { rank: "中吉", message: "頑張る日と休む日は、どちらも大切です。", item: "スニーカー" },

   { rank: "小吉", message: "好きな飲み物をゆっくり飲む時間を作りましょう。", item: "お気に入りのマグカップ" },
   { rank: "小吉", message: "今日は少しだけスマホを置いて、目を休ませましょう。", item: "アイマスク" },
   { rank: "小吉", message: "帰り道に小さなご褒美を買ってもいい日です。", item: "チョコレート" },
   { rank: "小吉", message: "予定をひとつ減らす勇気も、自分を守る力です。", item: "メモ帳" },
   { rank: "小吉", message: "誰かに優しくした分、自分にも優しくしましょう。", item: "ふわふわタオル" },

   { rank: "末吉", message: "今日は無理に前向きにならなくて大丈夫です。", item: "ふわふわの靴下" },
   { rank: "末吉", message: "心が重い日は、まず体を温めましょう。", item: "ホットミルク" },
   { rank: "末吉", message: "できなかったことより、できたことをひとつ数えましょう。", item: "小さなノート" },
   { rank: "末吉", message: "今日は静かに過ごすだけでも十分です。", item: "好きな音楽" },
   { rank: "末吉", message: "泣きたい日は、我慢しなくて大丈夫です。", item: "柔らかいティッシュ" },

   { rank: "凶", message: "休憩が必要です。予定をひとつ減らしても大丈夫。", item: "早寝" },
   { rank: "凶", message: "今日は頑張りすぎ注意。自分を後回しにしないでください。", item: "白湯" },
   { rank: "凶", message: "その疲れは気のせいではありません。ちゃんと休みましょう。", item: "湯船" },
   { rank: "凶", message: "無理して笑わなくて大丈夫。今日は省エネでいきましょう。", item: "ゆったりした服" },
   { rank: "凶", message: "人に優しくする前に、自分の心を守ってください。", item: "深呼吸" },

   { rank: "大吉", message: "今日は新しいことを始める小さな勇気が出そうです。", item: "新しいペン" },
   { rank: "吉", message: "頑張った自分に、ちゃんとありがとうを言いましょう。", item: "甘いラテ" },
   { rank: "中吉", message: "無理に答えを出さなくても、時間が整理してくれることがあります。", item: "散歩" },
   { rank: "小吉", message: "今日は少しだけ早く帰る工夫をしてみましょう。", item: "定時退社" },
   { rank: "末吉", message: "気分が上がらない日もあります。それでも大丈夫。", item: "好きなドラマ" },

   { rank: "大吉", message: "あなたが思っている以上に、ちゃんと前に進んでいます。", item: "明るいリップ" },
   { rank: "吉", message: "今日は小さな成功を見逃さないでください。", item: "お気に入りのアクセサリー" },
   { rank: "中吉", message: "相手の言葉を全部背負わなくて大丈夫です。", item: "香りのよいハンドソープ" },
   { rank: "小吉", message: "一息つく時間を予定に入れてください。", item: "カレンダー" },
   { rank: "末吉", message: "疲れた日は、最低限できれば合格です。", item: "簡単ごはん" },

   { rank: "凶", message: "今日は無理な約束をしない方がよさそうです。", item: "予定の見直し" },
   { rank: "吉", message: "自分の気持ちをなかったことにしないでください。", item: "日記" },
   { rank: "中吉", message: "誰かに相談するだけで、少し軽くなることがあります。", item: "友人へのLINE" },
   { rank: "小吉", message: "今日は自分の味方でいる練習をしましょう。", item: "鏡の前の深呼吸" },
   { rank: "大吉", message: "明日は今日より少しやさしい日になります。", item: "桜色の小物" },

   { rank: "末吉", message: "焦らなくて大丈夫。今は整える時期です。", item: "整理整頓" },
   { rank: "凶", message: "疲労サインが出ています。今日は早めに休みましょう。", item: "22時就寝" },
   { rank: "吉", message: "小さなご褒美が、明日の元気につながります。", item: "プリン" },
